% File: jpeg_compression.m
% Desc: Matlab code to simulate a JPEG compression. Adopted from "JPEG
% Tutorial, by Andrew B. Lewis, University of Cambridge, computer
% laboratory"

function [jpeg_result]=jpeg_compression1(original,qf)
% Transform matrices
dct_matrix = dctmtx(8);
